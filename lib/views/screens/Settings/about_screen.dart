                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "or pause your vacuum from anywhere using your smartphone.",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'ClashDisplay',
                          color: Colors.white,
                      ...
                      Text(
                        "schedules that fit your lifestyle. Choose specific days and times for a perfectly clean home without lifting a finger.",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'ClashDisplay',
                          color: Colors.white,
                      ...
                      Text(
                        "track of your vacuum’s cleaning progress and receive notifications when it’s done or needs maintenance.",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'ClashDisplay',
                          color: Colors.white,
                      ...
                      Text(
                        "Tailor your vacuum’s cleaning experience with options for spot cleaning, edge cleaning, and more.",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'ClashDisplay',
                          color: Colors.white,
                      ...
                      Text(
                        " real-time map of your home’s layout and see which areas have been cleaned or need attention.",
                        style: TextStyle(
                          fontSize: 18,
                          fontFamily: 'ClashDisplay',
                          color: Colors.white,
